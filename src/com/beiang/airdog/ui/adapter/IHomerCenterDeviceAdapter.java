...
public class IHomerCenterDeviceAdapter extends BaseAdapter {
	private List<RspHomeGetDev.Data> list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// device
		final RspHomeGetDev.Data mDevice = (RspHomeGetDev.Data) getItem(position);
		if (mDevice != null) {
			tag.dev_name.setText(mDevice.name);
			setItemIcon(mDevice.getDevType(), tag.dev_icon);

			if (0 == mDevice.is_online) {
