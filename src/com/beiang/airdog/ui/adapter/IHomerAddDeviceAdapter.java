 ...
 * 
 */
public class IHomerAddDeviceAdapter extends BaseAdapter {
	List<DevEntity> list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DevEntity data = (DevEntity) getItem(position);
		// device
		if (data != null) {
			tag.dev_name.setText(data.nickName);
			setItemIcon(data.devType, tag.dev_icon);

			if ("offline".equals(data.status)) {
