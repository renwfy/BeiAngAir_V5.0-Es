...
public class BounceScroller extends RelativeLayout {
	...
	public boolean dispatchTouchEvent(MotionEvent event) {
		...
		if (takeTouchEvent(event)) {
			...
			//Log.d(TAG, System.currentTimeMillis() + " dispatchTouchEvent " + result);
		}
		...
		if (action == MotionEvent.ACTION_CANCEL || action == MotionEvent.ACTION_UP) {
			...
			if (mTargetView != null && mTargetView.getVisibility() != View.VISIBLE) {
				...
				//Log.d(TAG, "targetTop " + targetTop + " viewOffset " + viewOffset + " eventOffset " + eventOffset + " mTimeBase "+ mTimeBase);
	...
	private class Bouncer implements AnimatorUpdateListener, AnimatorListener {
		...
		public void onAnimationUpdate(ValueAnimator va) {
			...
			//Log.d(TAG, "recover delta " + delta + " currentOffset " + currentOffset);
			offsetContent(delta);
